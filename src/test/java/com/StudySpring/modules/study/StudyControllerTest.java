...
public class StudyControllerTest {
    ...
    void createStudy_success() throws Exception {
        ...
        assertNotNull(study);
        Account account = accountRepository.findByNickname("pjs123");
    ...
    void viewStudy() throws Exception {
        ...
        studyService.createNewStudy(study, pjs123);
    ...
    void joinStudy() throws Exception {
        ...
        Account pjs123 = accountRepository.findByNickname("pjs123");
        assertTrue(study.getMembers().contains(pjs123));
    }
    ...
    void leaveStudy() throws Exception {
        ...
        Account pjs123 = accountRepository.findByNickname("pjs123");
        studyService.addMember(study, pjs123);

        mockMvc.perform(get("/study/" + study.getPath() + "/leave"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/study/" + study.getPath() + "/members"));

        assertFalse(study.getMembers().contains(pjs123));
    }
