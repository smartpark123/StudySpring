...
import com.StudySpring.study.form.StudyDescriptionForm;
import com.StudySpring.tag.TagRepository;
import com.StudySpring.tag.TagService;
...
public class StudySettingsController {
    ...
    public String viewStudySetting(@CurrentAccount Account account, @PathVariable String path, Model model) {
        Study study = studyService.getStudyToUpdate(account, path);  //수정할 스터디 정보를 가져옴
    ...
    public String publishStudy(@CurrentAccount Account account, @PathVariable String path,
        ...
        Study study = studyService.getStudyToUpdateStatus(account, path); //account 객체는 detached
        studyService.publish(study); //따라서 변경이 일어나기 때문에 Service로 넘겨야한다
