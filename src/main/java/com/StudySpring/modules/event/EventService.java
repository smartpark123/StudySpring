...
import com.StudySpring.modules.event.event.EnrollmentAcceptedEvent;
import com.StudySpring.modules.event.event.EnrollmentRejectedEvent;
...
public class EventService {
    ...
    public void updateEvent(Event event, EventForm eventForm) {
        ...
        //  모집 인원을 늘린 선착순 모임의 경우에, 자동으로 추가 인원의 참가 신청을 확정 상태로 변경해야 한다.
    ...
    public void newEnrollment(Event event, Account account) {
        if (!enrollmentRepository.existsByEventAndAccount(event, account)) { //해당 이벤트에대한 account에 대한 enrollment가 있다면 무시
