...
import com.StudySpring.modules.event.validator.EventValidator;
import com.StudySpring.modules.study.StudyService;
...
public class EventController {
    ...
    public String newEventForm(@CurrentAccount Account account, @PathVariable String path, Model model){
        Study study = studyService.getStudyToUpdateStatus(account, path);//매니저 정보
    ...
    @PostMapping("/events/{id}/edit")  //모임 수정
    ...
    @PostMapping("/events/{id}/enroll") //참가신청
