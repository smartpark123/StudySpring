...
class AccountControllerTest {
    ...
    void checkEmailToken() throws Exception{
        ...
        mockMvc.perform(get("/check-email-token")
                ...
                .andExpect(view().name("account/checked-email"))
                .andExpect(authenticated().withUsername("pjs123")); //pjs123로 인증이 되었는지 확인
    }
    ...
    void signUpSubmit_with_correct_input() throws Exception{
        mockMvc.perform(post("/sign-up")
                .param("nickname","pjs123")
                .param("email","pjs123@naver.com")
                .param("password","12345678")
                .with(csrf()))
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:/"))
                .andExpect(authenticated().withUsername("pjs123"));

        Account account = accountRepository.findByEmail("pjs123@naver.com");
